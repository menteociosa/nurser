...
We will be charging by the number of teams and admin can be in
Add a column to the teams table in the database which is "team_type" and and defaults to value "standard"
